...
class StudentDBHelper(context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        private const val SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBContract.UserEntry.TABLE_NAME + " (" + DBContract.UserEntry.COLUMN_NIM + " TEXT PRIMARYKEY," + DBContract.UserEntry.COLUMN_NAME + " TEXT," + DBContract.UserEntry.COLUMN_AGE + " TEXT)"
    ...
    fun searchStudentByNIM(nim: String): ArrayList<StudentModel> {
        ...
        try {
            cursor = db.rawQuery(
                "select * from " + DBContract.UserEntry.TABLE_NAME + " WHERE " + DBContract.UserEntry.COLUMN_NIM + "='" + nim + "'",
                null
            )
